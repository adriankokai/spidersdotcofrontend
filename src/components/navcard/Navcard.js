...
// Navcard component for navigation header

//switching to functional component --- IGNORE ---
const Navcard = (props) => {
    const bg = props.portfolio ? white1:white
    ...
    return (
        <div class="row" style={{margin: '1rem'}} >
            <div class="col s12" style={cardStyles} >
                <div class="card transparent z-depth-0" >
                        <div className="hide-on-med-and-down">
                            ...
                            <a 
                                href="/"
                                className="btn black right" 
                                style={props.blog ? linkButtonStylesActive : linkButtonStyles}
                            >
                                blog
                            </a>
                        </div>
